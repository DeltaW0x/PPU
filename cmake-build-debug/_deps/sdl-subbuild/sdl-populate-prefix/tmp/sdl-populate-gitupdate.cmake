...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "SDL2"
  WORKING_DIRECTORY "/Users/delta/Desktop/PPU/cmake-build-debug/_deps/sdl-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/delta/Desktop/PPU/cmake-build-debug/_deps/sdl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/delta/Desktop/PPU/cmake-build-debug/_deps/sdl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
